...
Route::group([], function () {
	...
	Route::post('update-status', 						['as' => 'update-status', 		'uses' => 'OrderController@updateStatus']);
	Route::post('update-delivery', 						['as' => 'update-delivery', 	'uses' => 'OrderController@updateDelivery']);
