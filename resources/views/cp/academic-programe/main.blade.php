...
@section('active-main-menu-academic-programe', 'opened')
@section('title')
	Academic Programe: @yield('section-title')
@endsection
	...
	<header class="page-content-header">
		<div class="container-fluid">
			<div class="tbl">
				<div class="tbl-row">
					<div class="tbl-cell">
						<h3>Academic Programe <span> <i class="fa fa-long-arrow-right"></i> @yield('section-title')</span></h3> 
					</div>
