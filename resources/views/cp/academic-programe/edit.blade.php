@extends($route.'.main')
@section ('section-title', 'Edit Academic Programe')
@section ('section-css')
...
@section ('section-js')
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="{{ asset($data->image) }}" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be 262x205 with .jpg or .png type</i></span>',
