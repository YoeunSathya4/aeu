@extends($route.'.main')
@section ('section-title', 'All Academic Programes')
...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-3">
		<div class="form-group">
			...
			<input  type="text" class="form-control" id="key" placeholder="Academic Programe title" value="{{ isset($appends['key'])?$appends['key']:'' }}">
		</div>
	</div>
