...
class OrderController extends Controller
{
    ...
    function updateStatus(Request $request){
        ...
        $now      = date('Y-m-d H:i:s');
        $id       = $request->input('id');
        $data     = array('is_success' => $request->input('active'));
        Model::where('id', $id)->update($data);
      
        return response()->json([
          'status' => 'success',
          'msg' => 'Success status has been updated.'
        ]);
    }
    ...
    function updateDelivery(Request $request){
        ...
        $now      = date('Y-m-d H:i:s');
        $id       = $request->input('id');
        $data     = array('is_delivery' => $request->input('active'));
        Model::where('id', $id)->update($data);
      
        return response()->json([
          'status' => 'success',
          'msg' => 'Delivery status has been updated.'
        ]);
    }
}
